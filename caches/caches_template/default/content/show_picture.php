...
<div class="main photo-channel">
	<div id="con">
		...
		<div id="Article">
			<h1><?php echo $title;?><br /><span><?php echo $inputtime;?>&nbsp;&nbsp;&nbsp;来源：<?php echo $copyfrom;?>&nbsp;&nbsp;&nbsp;评论：<a href="#comment_iframe" id="comment">0</a></span></h1>
			<div class="tool">
				<a name="pic"></a>
			...
			<div class="list-pic">
				...
				<div class="cont" style="position:relative">
					...
					<ul class="cont picbig" id="pictureurls"  style="position:absolute">
						...
						<li><div class="img-wrap"><a href="javascript:;" hidefocus="true"><img src="<?php echo thumb($r[thumb],150,112);?>" alt="<?php echo $r['alt'];?>" rel="<?php echo thumb($r[thumb],150,112);?>"/></a></div></li>
						<?php $n++;}unset($n); ?>
					</ul>
	...
	<div id="load_pic" style="display:none;" rel="<?php echo IMG_PATH;?>msg_img/loading_d.gif"></div>
</div>
